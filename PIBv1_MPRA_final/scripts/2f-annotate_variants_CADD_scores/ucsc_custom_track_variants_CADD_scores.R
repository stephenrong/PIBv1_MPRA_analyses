...
# load gr
introgressed_variants_CADD_ucsc_custom_track <- as_tibble(fread("../../results/2f-annotate_variants_CADD_scores/introgressed_variants_CADD_summ.txt.gz"))

# create bed
custom_palette = as.vector(paletteer_d("RColorBrewer::Set1"))

introgressed_variants_CADD_ucsc_custom_track_bed <- introgressed_variants_CADD_ucsc_custom_track %>% 
	mutate(
...
create_ucsc_custom_bedGraph_track(
	input_tb=introgressed_variants_CADD_ucsc_custom_track_bed, 
	output_bedGraph="../../results/2f-annotate_variants_CADD_scores/introgressed_variants_CADD_ucsc_custom_track.bedGraph", 
