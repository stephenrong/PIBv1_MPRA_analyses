...
Neanderthal_corehaps_variants_emVars <- Neanderthal_corehaps_variants %>% 
	filter(!is.na(MPRA_K562_summ_Summary) | !is.na(MPRA_Jurkat_summ_Summary))

Neanderthal_corehaps_variants_emVars_linked <- Neanderthal_corehaps_variants_emVars %>% 
...
Neanderthal_corehaps_variants_emVars_linked_abbrev_variants <- Neanderthal_corehaps_variants_emVars_linked %>% 
...
Neanderthal_corehaps_variants_emVars_linked_abbrev_variants_named <- Neanderthal_corehaps_variants_emVars_linked_abbrev_variants
names(Neanderthal_corehaps_variants_emVars_linked_abbrev_variants_named) <- c("Variant ID", "MPRA K562", "MPRA K562 log10FDR", "MPRA K562 log2FC", "MPRA Jurkat", "MPRA Jurkat log10FDR", "MPRA Jurkat log2FC", "ABC score list", "ABC gene symbol list", "ABC biosample list", "ABC category list", "EpiMap score list", "EpiMap gene symbol list", "EpiMap group list", "Roadmap Epigenomics score list", "Roadmap Epigenomics gene symbol list", "Roadmap Epigenomics biosample list", "Roadmap Epigenomics category list", "CADD score", "phyloP score")
write_tsv(Neanderthal_corehaps_variants_emVars_linked_abbrev_variants_named, "../../results/4-table_emVars_linked_gene_lists/Supplementary_Table_SX-Neanderthal_Corehaps_introgressed_MPRA_emVar_variants_with_gene_enhancer_links_in_final_dataset.txt")
...
Neanderthal_corehaps_variants_emVars_linked_variant_gene_pairs <- Neanderthal_corehaps_variants_emVars_linked %>% 
...
Neanderthal_corehaps_variants_emVars_linked_variant_gene_pairs_named <- Neanderthal_corehaps_variants_emVars_linked_variant_gene_pairs
names(Neanderthal_corehaps_variants_emVars_linked_variant_gene_pairs_named) <- c("Variant ID", "Gene symbol", "Gene-enhancer methods count", "Gene-enhancer methods list", "CADD score", "phyloP score")
write_tsv(Neanderthal_corehaps_variants_emVars_linked_variant_gene_pairs_named, "../../results/4-table_emVars_linked_gene_lists/Supplementary_Table_SX-Pairs_of_Neanderthal_corehaps_introgressed_MPRA_emVar_variants_and_linked_genes_in_final_dataset.txt")

# Look up for a given gene which variants are linked
Neanderthal_corehaps_variants_emVars_linked_genes <- Neanderthal_corehaps_variants_emVars_linked_variant_gene_pairs %>% 
...
Neanderthal_corehaps_variants_emVars_linked_genes_named <- Neanderthal_corehaps_variants_emVars_linked_genes
names(Neanderthal_corehaps_variants_emVars_linked_genes_named) <- c("Gene symbol", "emVar+linked variant count", "Variant ID list")
write_tsv(Neanderthal_corehaps_variants_emVars_linked_genes_named, "../../results/4-table_emVars_linked_gene_lists/Supplementary_Table_SX-Genes_with_Neanderthal_corehaps_introgressed_MPRA_emVars_in_final_dataset.txt")

# Look up which genes have the most links
Neanderthal_corehaps_variants_emVars_linked_genes_collapse <- Neanderthal_corehaps_variants_emVars_linked_genes %>% 
	group_by(`Linked variant count`) %>% summarise(`Count` = dplyr::n(), `Genes` = paste(`Gene`, collapse=",")) %>% ungroup() %>% 
	arrange(desc(`Linked variant count`))
Neanderthal_corehaps_variants_emVars_linked_genes_collapse_named <- Neanderthal_corehaps_variants_emVars_linked_genes_collapse
names(Neanderthal_corehaps_variants_emVars_linked_genes_collapse_named) <- c("emVar+linked variant count", "Gene count", "Gene symbol list")
write_tsv(Neanderthal_corehaps_variants_emVars_linked_genes_collapse_named, "../../results/4-table_emVars_linked_gene_lists/Supplementary_Table_SX-Gene_lists_by_count_of_Neanderthal_corehaps_introgressed_MPRA_emVars_in_final_dataset.txt")
