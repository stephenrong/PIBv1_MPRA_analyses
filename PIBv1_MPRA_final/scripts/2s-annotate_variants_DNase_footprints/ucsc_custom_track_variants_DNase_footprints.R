...
# load gr
introgressed_variants_DNase_footprints_ucsc_custom_track <- as_tibble(fread("../../results/2s-annotate_variants_DNase_footprints/introgressed_variants_DNase_footprints_summ.txt.gz"))

# create bed
custom_palette = as.vector(paletteer_d("RColorBrewer::Set1"))

introgressed_variants_DNase_footprints_ucsc_custom_track <- introgressed_variants_DNase_footprints_ucsc_custom_track %>% 
	mutate(
		bed_chrom=seqnames,
...
create_ucsc_custom_bed_track(
	input_tb=introgressed_variants_DNase_footprints_ucsc_custom_track, 
	output_bed="../../results/2s-annotate_variants_DNase_footprints/introgressed_variants_DNase_footprints_ucsc_custom_track.bed", 
