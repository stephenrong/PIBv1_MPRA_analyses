...
INPUT="../../results/2d-annotate_variants_gnomAD_AFs/introgressed_variants_lift38_chr_lift37-gnomad.genomes.v3.1.2.sites.vcf.gz"
OUTPUT="../../results/2d-annotate_variants_gnomAD_AFs/introgressed_variants_lift38_chr_lift37_abbrev-gnomad.genomes.v3.1.2.sites.vcf.gz"
