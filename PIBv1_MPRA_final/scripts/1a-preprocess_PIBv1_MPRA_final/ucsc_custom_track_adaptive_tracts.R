...
# load gr
adaptive_tracts_ucsc_custom_track <- as_tibble(fread("../../results/1a-preprocess_PIBv1_MPRA_final/adaptive_tracts.txt.gz"))

# create bed
custom_palette = as.vector(paletteer_c("viridis::viridis", n=length(unique(adaptive_tracts_ucsc_custom_track$Tracts_SprimePopulation))))
...
create_ucsc_custom_bed_track(
	...
	output_bed="../../results/1a-preprocess_PIBv1_MPRA_final/adaptive_tracts_ucsc_custom_track.bed", 
