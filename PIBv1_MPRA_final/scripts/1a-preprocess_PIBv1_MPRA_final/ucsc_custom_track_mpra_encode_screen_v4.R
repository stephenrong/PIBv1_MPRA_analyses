...
create_ucsc_custom_bed_track(
	...
	output_bed="../../results/1a-preprocess_PIBv1_MPRA_final/mpra_encode_screen_v4_ucsc_custom_track.bed", 
...
create_ucsc_custom_bed_track(
	...
	output_bed="../../results/1a-preprocess_PIBv1_MPRA_final/mpra_encode_screen_v4_ucsc_custom_track_PLS.bed", 
...
create_ucsc_custom_bed_track(
	...
	output_bed="../../results/1a-preprocess_PIBv1_MPRA_final/mpra_encode_screen_v4_ucsc_custom_track_pELS.bed", 
...
create_ucsc_custom_bed_track(
	...
	output_bed="../../results/1a-preprocess_PIBv1_MPRA_final/mpra_encode_screen_v4_ucsc_custom_track_dELS.bed", 
...
create_ucsc_custom_bed_track(
	...
	output_bed="../../results/1a-preprocess_PIBv1_MPRA_final/mpra_encode_screen_v4_ucsc_custom_track_CA-TF.bed", 
