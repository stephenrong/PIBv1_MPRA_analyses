...
# 1a-preprocess_PIBv1_MPRA_pilot:
Rscript preprocess_PIBv1_MPRA_pilot.R
...
# 2i-annotate_variants_MPRA_pilot:
Rscript postprocess_variants_MPRA_pilot_Jurkat.R
Rscript postprocess_variants_MPRA_pilot_K562.R
Rscript ucsc_custom_track_variants_MPRA_pilot_Jurkat.R
Rscript ucsc_custom_track_variants_MPRA_pilot_K562.R
Rscript visualize_variants_MPRA_pilot_Jurkat.R
Rscript visualize_variants_MPRA_pilot_K562.R
...
# 2o-annotate_variants_nearest_gene:
...
Rscript ucsc_custom_track_variants_gene_enhancer_links_ABC.R
Rscript ucsc_custom_track_variants_gene_enhancer_links_ABC_all.R
Rscript ucsc_custom_track_variants_gene_enhancer_links_EpiMap.R
Rscript ucsc_custom_track_variants_gene_enhancer_links_EpiMap_all.R
Rscript ucsc_custom_track_variants_gene_enhancer_links_Roadmap_Epigenomics.R
Rscript ucsc_custom_track_variants_gene_enhancer_links_Roadmap_Epigenomics_all.R
...
# 3-mpra_sanity_check_analyses:
Rscript mpra_sanity_check_analyses.R

# 3-overlap_emVars_GWAS_cCREs:
Rscript overlap_emVars_GWAS_cCREs.R

# 4-simple_gene_set_enrichment_analysis_alt:
Rscript simple_gene_set_enrichment_analysis_alt.R

# 4-table_consequence_gene_lists:
Rscript table_consequence_gene_lists.R

# 4-table_emVars_cCREs_gene_lists:
Rscript table_emVars_cCREs_gene_lists.R

# 4-table_emVars_linked_gene_lists:
Rscript table_emVars_linked_gene_lists.R

# 5-emVar_TF_motif_disruption_analysis:
Rscript -e "rmarkdown::render('emVar_TF_motif_disruption_analysis_Jurkat.Rmd')"
Rscript -e "rmarkdown::render('emVar_TF_motif_disruption_analysis_K562.Rmd')"
Rscript -e "rmarkdown::render('emVar_TF_motif_disruption_analysis_K562andJurkat.Rmd')"
Rscript -e "rmarkdown::render('emVar_TF_motif_disruption_cell_line_comparison.Rmd')"
