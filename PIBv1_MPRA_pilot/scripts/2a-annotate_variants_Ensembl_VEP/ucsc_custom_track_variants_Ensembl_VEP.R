...
# load gr
adaptive_variants_Ensembl_VEP <- as_tibble(fread("../../results/2a-annotate_variants_Ensembl_VEP/adaptive_variants_Ensembl_VEP_summ.txt.gz"))

# create bed
custom_palette = as.vector(paletteer_d("RColorBrewer::Set1"))

adaptive_variants_Ensembl_VEP_ucsc_custom_track <- adaptive_variants_Ensembl_VEP %>% 
	mutate(
		bed_chrom=seqnames,
...
create_ucsc_custom_bed_track(
	input_tb=adaptive_variants_Ensembl_VEP_ucsc_custom_track, 
	output_bed="../../results/2a-annotate_variants_Ensembl_VEP/adaptive_variants_Ensembl_VEP_ucsc_custom_track.bed", 
