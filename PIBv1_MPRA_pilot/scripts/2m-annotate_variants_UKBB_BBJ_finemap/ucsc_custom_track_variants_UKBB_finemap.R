...
# load gr
adaptive_variants_UKBB_finemap_ucsc_custom_track <- as_tibble(fread("../../results/2m-annotate_variants_UKBB_BBJ_finemap/adaptive_variants_UKBB_finemap_summ.txt.gz"))
adaptive_variants_UKBB_finemap_ucsc_custom_track <- adaptive_variants_UKBB_finemap_ucsc_custom_track %>% 
	filter(!is.na(UKBB_finemap_summ_Summary))

# create bed
custom_palette = as.vector(paletteer_d("RColorBrewer::Set1"))

adaptive_variants_UKBB_finemap_ucsc_custom_track_bed <- adaptive_variants_UKBB_finemap_ucsc_custom_track %>% 
	mutate(
		bed_chrom=seqnames,
...
create_ucsc_custom_bed_track(
	input_tb=adaptive_variants_UKBB_finemap_ucsc_custom_track_bed, 
	output_bed="../../results/2m-annotate_variants_UKBB_BBJ_finemap/adaptive_variants_UKBB_finemap_ucsc_custom_track.bed", 
