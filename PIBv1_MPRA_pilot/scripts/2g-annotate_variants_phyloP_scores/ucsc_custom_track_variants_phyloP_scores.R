...
# load gr
adaptive_variants_phyloP_ucsc_custom_track <- as_tibble(fread("../../results/2g-annotate_variants_phyloP_scores/adaptive_variants_phyloP_summ.txt.gz"))

# create bed
custom_palette = as.vector(paletteer_d("RColorBrewer::Set1"))

adaptive_variants_phyloP_ucsc_custom_track_bed <- adaptive_variants_phyloP_ucsc_custom_track %>% 
	mutate(
...
create_ucsc_custom_bedGraph_track(
	input_tb=adaptive_variants_phyloP_ucsc_custom_track_bed, 
	output_bedGraph="../../results/2g-annotate_variants_phyloP_scores/adaptive_variants_phyloP_ucsc_custom_track.bedGraph", 
