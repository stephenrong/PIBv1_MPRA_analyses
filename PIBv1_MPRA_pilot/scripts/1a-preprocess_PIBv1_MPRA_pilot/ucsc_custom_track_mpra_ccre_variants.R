...
# load gr
mpra_ccre_variants_ucsc_custom_track <- as_tibble(fread("../../results/1a-preprocess_PIBv1_MPRA_pilot/mpra_ccre_variants.txt.gz"))
...
create_ucsc_custom_bed_track(
	...
	output_bed="../../results/1a-preprocess_PIBv1_MPRA_pilot/mpra_ccre_variants_ucsc_custom_track.bed", 
