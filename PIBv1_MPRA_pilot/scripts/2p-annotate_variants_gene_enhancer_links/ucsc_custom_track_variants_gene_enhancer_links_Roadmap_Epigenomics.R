...
# load Roadmap_Epigenomics_max
Roadmap_Epigenomics_max_gene_enhancer_links <- as_tibble(fread("../../results/2p-annotate_variants_gene_enhancer_links/adaptive_variants_Roadmap_Epigenomics_interact_max.txt.gz"))
Roadmap_Epigenomics_max_gene_enhancer_links_abbrev <- Roadmap_Epigenomics_max_gene_enhancer_links %>% 
	GRanges() %>% seqinfo_fix("UCSC", "hg19") %>% as_tibble()

Roadmap_Epigenomics_max_gene_enhancer_links_abbrev <- Roadmap_Epigenomics_max_gene_enhancer_links_abbrev %>% 
...
Roadmap_Epigenomics_max_gene_enhancer_links_emVar <- Roadmap_Epigenomics_max_gene_enhancer_links_abbrev %>% 
...
Roadmap_Epigenomics_max_gene_enhancer_links_emVar <- Roadmap_Epigenomics_max_gene_enhancer_links_emVar %>% 
	rowwise() %>% 
	mutate(
...
create_ucsc_custom_interact_track(
	input_tb=Roadmap_Epigenomics_max_gene_enhancer_links_emVar,
	output_interact="../../results/2p-annotate_variants_gene_enhancer_links/adaptive_variants_Roadmap_Epigenomics_max_emVar_ucsc_custom_track.interact", 
	name="Roadmap Epigenomics-Max+emVar gene enhancer links", description="Roadmap Epigenomics-Max+emVar gene enhancer links", interactDirectional="true", maxHeightPixels="200:100:50", visibility="full")
