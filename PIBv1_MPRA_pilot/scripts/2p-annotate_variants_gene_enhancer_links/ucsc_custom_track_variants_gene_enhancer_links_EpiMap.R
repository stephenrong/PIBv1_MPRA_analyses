...
# load EpiMap_max
EpiMap_max_gene_enhancer_links <- as_tibble(fread("../../results/2p-annotate_variants_gene_enhancer_links/adaptive_variants_EpiMap_interact_max.txt.gz"))
EpiMap_max_gene_enhancer_links_abbrev <- EpiMap_max_gene_enhancer_links %>% 
	GRanges() %>% seqinfo_fix("UCSC", "hg19") %>% as_tibble()

EpiMap_max_gene_enhancer_links_abbrev <- EpiMap_max_gene_enhancer_links_abbrev %>% 
...
EpiMap_max_gene_enhancer_links_emVar <- EpiMap_max_gene_enhancer_links_abbrev %>% 
...
EpiMap_max_gene_enhancer_links_emVar <- EpiMap_max_gene_enhancer_links_emVar %>% 
	rowwise() %>% 
	mutate(
...
create_ucsc_custom_interact_track(
	input_tb=EpiMap_max_gene_enhancer_links_emVar,
	output_interact="../../results/2p-annotate_variants_gene_enhancer_links/adaptive_variants_EpiMap_max_emVar_ucsc_custom_track.interact", 
	name="EpiMap-Max+emVar gene enhancer links", description="EpiMap-Max+emVar gene enhancer links", interactDirectional="true", maxHeightPixels="200:100:50", visibility="full")
